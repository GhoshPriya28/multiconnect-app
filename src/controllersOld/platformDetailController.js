...
// const reconRegion = process.env.RECON_BUCKET_REGION;
// const reconAccessKeyId = process.env.RECON_ACCESS_KEY;
// const reconSecretAccessKey = process.env.RECON_SECRET_ACCESS_KEY;
...
// const reconS3 = new S3({
//     // region: reconRegion,
//     accessKeyId: reconAccessKeyId,
//     secretAccessKey: reconSecretAccessKey,
// });
...
const send_notificationOld = async (req, res) => {
    ...
    await sequelize.query(notificationInsert).then( async insertN => {
        var maxIdQ = "SELECT MAX(id) as notification_id FROM `notification_details` ";
           ...
           let user_firebase_id = value.user_firebase_id ? value.user_firebase_id : 'NO ID';
            ...
            const returnData = notificationUtility.sentNotificationMultiple(firebaseIds, title, data, notification_id,plateform);
    });
...
module.exports = { platformDetailView, userDetailView, downloadAssets, createZipFileFromS3, enableReupload, userlistdataNotification, send_notification, notificationdetail, notificatiomaster };