...
const { platformDetailView, userDetailView, downloadAssets, enableReupload, userlistdataNotification, send_notification, notificationdetail, notificatiomaster, usersReport, tychoUserDetailView, tychoUserlistdataNotification, tychoUsersReport, send_notification_tychostream, notificationDetailTychoStream, notificatioMasterTychoStream } = require('../controllers/platformDetailController');
...
// tycho stream
router.get('/tychostream', tychoUserDetailView)
router.get('/tychostream-notification', tychoUserlistdataNotification)
router.get('/tychostream-notification-detail', notificationDetailTychoStream)
router.post("/send-stream-notification",send_notification_tychostream)
router.get('/tychostream-user-report/:id', tychoUsersReport);
router.get("/tychostream-notificatiomaster/:id", notificatioMasterTychoStream);
